...
if [ -z != $1 ] && [ -z != $2  ]
	...
	echo
	  ...
	  docker run -d -p 90${x}0:8080 -p 90${x}7:7077 -p 90${x}6:6066 --name "spark2.0-master" -h  "spark2.0-master" -v /media/sf_VM_Dev/test-results-docker:/usr/local/test -m 512M --memory-swap 0M futureapplications/streaming-spark2.0-master 
	  docker exec "spark2.0-master" usr/local/spark/sbin/start-master.sh 
